...
| Field     | BSON Type | Description                                               |
|-----------|-----------|-----------------------------------------------------------|
| `fil_id`  | `binData` | Reference to a `file` entry                               |
...
| `02-create-file.js`       | Creates the `file` collection with JSON Schema validation |
| `03-create-citation.js`   | Creates the `citation` collection with JSON Schema validation |
