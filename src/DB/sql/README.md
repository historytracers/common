...
| `sfo_id`          | `BINARY(16)`| UUID of citation format            | `SfoID`       |
...
|-----------------|-------------|--------------------------------|
| `sfo_id`        | `BINARY(16)`| Unique identifier (primary key)|
| `sfo_name`      | `TEXT`      | Format name                    |
| `sfo_description`| `TEXT`     | Format description             |
...
| Column    | Type        | Description                                      |
|-----------|-------------|--------------------------------------------------|
| `fil_id`  | `BINARY(16)`| Reference to `files` entry                        |
